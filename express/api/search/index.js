// TODO: Pull the caches from the configuration and make use of them for results
// TODO:  Make "search" and "suggest" work separately
...
module.exports = function(config) {
    ...
    return express.Router().get('/', function(req, res){
        ...
        var options = {
            "url" : config['couch.url'] + "/_design/app/_view/flat",
            "json": true
        };
